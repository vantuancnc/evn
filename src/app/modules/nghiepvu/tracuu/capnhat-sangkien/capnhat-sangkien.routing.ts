...
import { ApiInputDetailResolver, ApiInputListResolver } from './capnhat-sangkien.resolvers';
...
export const CapNhatSangkienRoutes: Route[] = [
  {
    path: '',
    component: CapnhatSangkienComponent,
    children: [
      {
