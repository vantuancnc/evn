...
import { ApiInputDetailResolver, ApiInputListResolver } from './tracuu-timkiem.resolvers';
...
export const TraCuuTimKiemRoutes: Route[] = [
  {
    path: '',
    component: TracuuTimKiemComponent,
    children: [
      {
