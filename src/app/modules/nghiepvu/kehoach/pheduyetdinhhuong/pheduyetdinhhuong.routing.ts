...
import { ApiInputDetailResolver, ApiInputListResolver } from './pheduyetdinhhuong.resolvers';
...
export const ApiPheDuyetDinhHuongRoutes: Route[] = [
  {
    path: '',
    component: ApiPheDuyetDinhHuongComponent,
    children: [
      {
        component: ApiPheduyetdinhhuongListComponent,
