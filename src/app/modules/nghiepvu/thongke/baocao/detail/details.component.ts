    ...
    export() {
      let obj={
        loaiThongKe:this.loaiThongKe,
          ...
          this._serviceApi.execServiceLogin("812E1113-7206-43DA-B3FA-71509FEF209C", [{"name":"LOAI_TIM_KIEM","value":this.loaiTimKiem},{"name":"TIM_KIEM","value":JSON.stringify(obj)}]).subscribe((data) => {
