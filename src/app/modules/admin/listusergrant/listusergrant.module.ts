...
import { ListUserGrantGroupComponent } from './group/group.component';
...
import { ListUserGrantRoutes } from './listusergrant.routing';
...
@NgModule({
  imports: [
    RouterModule.forChild(ListUserGrantRoutes), MatButtonModule, CodemirrorModule,MatTreeModule,DragDropModule,MatCheckboxModule,
  ...
  declarations: [
    ListUserGrantListComponent,
    ListUserGrantGroupComponent,
    ListUserGrantComponent,
    ListUserGrantDetailsComponent,
    ListUserGrantEmptyDetailsComponent]
})
export class ListUserGrantModule { }
