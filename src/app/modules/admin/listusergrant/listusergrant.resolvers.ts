...
export class ListUserGrantGroupsResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    constructor(private _listUserService: ListUserGrantService) {
    }
...
export class ListUserGrantResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class ListUserGrantDetailResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> {
        ...
        const sources = [];
        sources.push(this._listUserService.getAuthorityFunctionById());
        // If folder is set on the parameters...
