...
export class ListFunctionListResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any[]> | any {
        ...
        sources.push(this._ListFunctionService.getListFunctionByAll());
        sources.push(this._ListFunctionService.getLstService());
            ...
            .pipe(
                finalize(() => {
                    ...
                    if (!currentRoute.paramMap.get('id')) {
                        // Reset the Api
                        this._ListFunctionService.resetObject().subscribe();
                    }
                }),
...
export class ListFunctionDetailResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> {
        ...
        if (route.paramMap.get('id')) {
            sources.push(this._ListFunctionService.getObjectById(route.paramMap.get('id')));
        }
