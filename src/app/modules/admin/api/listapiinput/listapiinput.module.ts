...
import { ApiInputRoutes } from './listapiinput.routing';
...
@NgModule({
  imports: [
    RouterModule.forChild(ApiInputRoutes), MatButtonModule,
  ...
  declarations: [
    ApiInputListComponent,
    ApiInputComponent,
    ApiInputDetailsComponent,
    ApiInputEmptyDetailsComponent]
})
