...
export class ApiGroupsResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any[]> {
        return this._apiService.getGroups();
    }
}
...
export class ApiApisResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any[]> | any {
        ...
        if (route.paramMap.get('group')) {
            sources.push(this._apiService.getApisByFolder(route.paramMap.get('group'), route.paramMap.get('page')));
            sources.push(this._apiService.getApiGroupById(route.paramMap.get('group')));
            sources.push(this._apiService.getLstApiTypes());
            sources.push(this._apiService.getLstApiOutput());
            sources.push(this._apiService.getLstApiInput());
        }
            ...
            .pipe(
                finalize(() => {
                    ...
                    if (!currentRoute.paramMap.get('id')) {
                        // Reset the Api
                        this._apiService.resetObject().subscribe();
                    }
                }),
...
export class ApiDetailResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> {
        ...
        if (route.paramMap.get('id')) {
            sources.push(this._apiService.getApiById(route.paramMap.get('id')));
            sources.push(this._apiService.getApiInputById(route.paramMap.get('id')));
        }
