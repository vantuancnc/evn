...
import { ApiGroupRoutes } from './listapigroup.routing';
...
@NgModule({
  imports: [
    RouterModule.forChild(ApiGroupRoutes), MatButtonModule, MatTreeModule,
  ...
  declarations: [
    ...
    ApiGroupComponent,
    ApiGroupDetailsComponent,
    ApiGroupEmptyDetailsComponent]
})
