...
import { OrganizationRoutes } from './listorganization.routing';
...
@NgModule({
  imports: [
    RouterModule.forChild(OrganizationRoutes), MatButtonModule, MatTreeModule,
  ...
  declarations: [
    ...
    OrganizationEmptyDetailsComponent]
})
