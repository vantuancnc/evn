...
export class ListRoleListResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any[]> | any {
        ...
        sources.push(this._listroleService.getListRoleByAll());
        sources.push(this._listroleService.getAuthorityFunctionById());
            ...
            .pipe(
                finalize(() => {
                    ...
                    if (!currentRoute.paramMap.get('id')) {
                        // Reset the Api
                        this._listroleService.resetObject().subscribe();
                    }
                }),
...
export class ListRoleDetailResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> {
        ...
        if (route.paramMap.get('id')) {
            sources.push(this._listroleService.getObjectById(route.paramMap.get('id')));
        }
